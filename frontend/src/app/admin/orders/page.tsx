              ...
              {orders.length === 0 ? (
                ...
                orders.map((order: any) => (
                  <tr key={order.id} className="hover:bg-neutral-800/30 transition-colors">
                    ...
                    <td className="px-6 py-4 text-neutral-300 hidden md:table-cell">₹{order.amount?.toLocaleString('en-GB', { day: '2-digit', month: 'short', year: 'numeric', hour: '2-digit', minute: '2-digit', hour12: false }) || 0}</td>
